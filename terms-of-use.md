...
These terms of service ("Terms") apply to your access and use of AvaSwap (the "Service"). Please read them carefully.
...
Whenever we make changes to these Terms, the changes are effective 24/1/2024 after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check AvaSwap for changes to these Terms.

If you continue to use the Service after the revised Terms go into effect, then you have accepted the changes to these Terms.

## Privacy Policy

For information about how we collect and use information about users of the Service, please check out our privacy policy available at https://github.com/PKai94/AvaSwap/blob/main/PRIVACY_POLICY.md.
...
Please let us know what you think of the Service, these Terms and, in general, AvaSwap. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, AvaSwap, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.
